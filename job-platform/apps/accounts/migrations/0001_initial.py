    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CLIENT', 'Client'), ('WORKER', 'Worker'), ('ADMIN', 'Admin')], default='WORKER', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_work_types', models.CharField(blank=True, help_text='Comma-separated, e.g. Moving, Delivery, Cleaning', max_length=255)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('worker', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='availability', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='WorkerProfile',
